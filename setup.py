...
setuptools.setup(
    ...
    version='20210203191726_06780F',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - ToxicCommentClassification:20210203191726_06780F
...
""",
    ...
    package_data={
        'ToxicCommentClassification': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'ToxicCommentClassification=ToxicCommentClassification:cli',
        ],
    }
)
